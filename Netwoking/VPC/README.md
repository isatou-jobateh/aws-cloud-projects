# AWS Builder Lab – Introduction to Amazon Virtual Private Cloud (VPC)

## Overview

In this lab, I explored Amazon Virtual Private Cloud (Amazon VPC) by creating a virtual network and configuring the components required for secure communication between AWS resources and the internet.
